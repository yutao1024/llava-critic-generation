...
if __name__ == "__main__":
    ...
    parser.add_argument("--question-file", type=str, default="tmp/llava_7b_v1_preference.jsonl")
    parser.add_argument("--answers-file", type=str, default="./tmp/llava_critic_7b_iter1.jsonl")
